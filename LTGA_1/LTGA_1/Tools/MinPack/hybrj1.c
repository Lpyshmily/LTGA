...
/*       subroutine hybrj1(fcn,n,x,fvec,fjac,ldfjac,xtol,info,wa,lwa) */
...
/* L10: */
    ...
    lr = n * (n + 1) / 2;
    info =hybrj(fcndernn, n, &x[1], &fvec[1], para, &fjac[fjac_offset], ldfjac, xtol,
