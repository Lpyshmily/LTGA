...
/*       subroutine lmstr1(fcn,m,n,x,fvec,fjac,ldfjac,xtol,info, */
/*                         ipvt,wa,lwa) */
...
/*         error in the sum of squares is at most xtol or that */
...
/*                   in the sum of squares is at most xtol. */
...
/*         info = 6  xtol is too small. no further reduction in */
...
/*     call lmstr. */
    ...
    mode = 1;
    nprint = 0;
    info = lmstr(fcnderstrmn, m, n, x, fvec, para, fjac, ldfjac,
