...
/*    data dmach(3) /1.79769313485d+308/ */
    ...
    switch(i) {
        case 1:
            return DPMPAR(double,EPSILON); /* 2.2204460492503131e-16 | 1.19209290e-07F */
        case 2:
            return DPMPAR(double,MIN);    /* 2.2250738585072014e-308 | 1.17549435e-38F */
        default:
            return DPMPAR(double,MAX);    /* 1.7976931348623157e+308 | 3.40282347e+38F */
    }
